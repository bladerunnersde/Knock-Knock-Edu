            ...
            <Card.Body className="mb-n5">
              <div className="d-flex align-items-center flex-column mb-5">
                <div className="mb-5 d-flex align-items-center flex-column">
                  ...
                  <div className="h5 mb-0">Happy Zong</div>
                  <div className="text-muted mb-2">Spanish</div>
                  <div className="text-muted text-center">I love Knock Knock Edu.</div>
                </div>
              ...
              <div className="mb-5">
                ...
                <p>I'm a high school student who is from Shenzhen, China.</p>
              </div>
              <div className="mb-5">
                ...
                <NavLink to="#" className="d-block body-link mb-1">
                  ...
                  <span className="align-middle">kk-edu.com</span>
                </NavLink>
                <NavLink to="#" className="d-block body-link mb-1">
                  <CsLineIcons icon="email" className="me-2" size="17" />
                  <span className="align-middle">david.li@gmail.com</span>
                </NavLink>
              </div>
            </Card.Body>
          </Card>
