    ...
    <>
      ...
      <Row>
        ...
        <Col xl="6" className="mb-5">
          <h2 className="small-title">Playground</h2>
          <Card className="mb-2">
        ...
        <Col xl="6" className="mb-5" id="introFirst">
          ...
          <Card className="sh-50 sh-md-40 h-xl-100-card hover-img-scale-up">
            ...
            <div className="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
              <div>
                <div className="cta-1 mb-3 text-white w-75 w-sm-50">Introduction to Movie Dubbing</div>
                <div className="w-50 text-white mb-3">Master English as if you were an actor in the film.</div>
                <Rating
                  className="mb-2"
                  initialRating={5}
                  readonly
            ...
            <Glide.Item>
              <Card className="mb-5 sh-25">
                <Card.Body className="text-center align-items-center d-flex flex-column justify-content-between">
                  ...
                  <p className="card-text mb-0 d-flex">KK Rookie</p>
            ...
            <Glide.Item>
              <Card className="mb-5 sh-25">
                <Card.Body className="text-center align-items-center d-flex flex-column justify-content-between">
                  ...
                  <p className="card-text mb-0 d-flex">KK Jedi Master</p>
