...
const mailboxData = [
  {
    ...
    emails: [
      ...
      },
      {
        ...
        attachments: [],
        content:
          'Hi Joisse, <br/><br/>Danish brownie chocolate bar lollipop cookie tootsie roll candy canes. Jujubes lollipop cheesecake gummi bears cheesecake. Cake jujubes soufflé. <br/><br/>Best Regards, <br/>Vincent Choi',
      },
      {
        name: 'Joisse Kaycee',
        address: 'joissekaycee@gmail.com',
      ...
      },
      {
        ...
        attachments: [],
        content:
          'Hey, <br/><br/>Jelly-o jelly oat cake cheesecake halvah. Cupcake sweet roll donut. Sesame snaps lollipop macaroon. Icing tiramisu oat cake chocolate cake marzipan pudding danish gummies. Dragée liquorice jelly beans jelly jelly sesame snaps brownie. <br/><br/>Best Regards, <br/>Vincent Choi',
      },
      {
        name: 'Joisse Kaycee',
        address: 'joissekaycee@gmail.com',
      ...
      },
      {
        ...
        content:
          'Hey Joisse, <br/><br/>Marzipan pudding danish gummies. Dragée liquorice jelly beans jelly jelly sesame snaps brownie. Liquorice gummi bears cake donut chocolate lollipop gummi bears. <br/><br/>Best Regards, <br/>Vincent Choi',
      },
    ],
  },
  {
    ...
    emails: [
      {
        ...
        attachments: [],
        content:
          'Hello, <br/><br/>Liquorice gummi bears cake donut chocolate lollipop gummi bears. Cotton candy cupcake ice cream gummies dessert muffin chocolate jelly.<br/><br/>Best Regards, <br/>Charlie Xiao',
      },
      {
        name: 'Joisse Kaycee',
        address: 'joissekaycee@gmail.com',
        ...
        attachments: [],
        content:
          'Dear Charlie Xiao, <br/><br/>Muffin cheesecake sesame snaps. Donut lollipop chocolate cake. Cheesecake oat cake croissant topping lemon drops macaroon sweet roll. Bonbon dragée marshmallow tootsie roll cupcake croissant chocolate cake candy topping. <br/><br/>Best Regards, <br/>Joisse Kaycee',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    folder: 'inbox',
    from: 'Nemo Huang',
    title: 'Introduction to Jedi Master ',
